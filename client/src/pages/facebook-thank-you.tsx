...
export default function FacebookThankYou() {
  return (
    <div className="min-h-screen bg-background">
      <Navigation />
      
      <section className="min-h-screen flex items-center justify-center py-16 bg-gradient-to-br from-blue-600 to-blue-800">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          ...
          <p className="text-xl mb-4" data-testid="thank-you-subtitle">Your Facebook Ads inquiry has been received.</p>
          <p className="text-lg text-white/90 mb-8" data-testid="thank-you-description">
            Our Facebook advertising experts will review your request and get back to you within 24 hours with a customized strategy and quote.
          </p>
          ...
          <div className="bg-white/20 backdrop-blur-sm rounded-xl p-6 mb-8" data-testid="next-steps">
            ...
            <ul className="text-left space-y-2 text-white/90">
              <li className="flex items-center">
                ...
                Our team will analyze your business and goals
              </li>
              <li className="flex items-center">
                <CheckCircle className="mr-2 h-5 w-5" />
                We'll create a custom Facebook Ads strategy
              </li>
              <li className="flex items-center">
                <CheckCircle className="mr-2 h-5 w-5" />
