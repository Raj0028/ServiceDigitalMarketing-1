...
export default function TiktokThankYou() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="min-h-screen flex items-center justify-center py-16 bg-gradient-to-br from-gray-900 to-gray-700">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          <div className="success-checkmark w-24 h-24 mx-auto mb-8 bg-white rounded-full flex items-center justify-center" data-testid="success-checkmark">
            <CheckCircle className="text-4xl text-gray-900 w-12 h-12" />
          </div>
          
          <h1 className="text-4xl sm:text-5xl font-bold mb-6" data-testid="thank-you-title">Thank You!</h1>
          <p className="text-xl mb-4" data-testid="thank-you-subtitle">Your TikTok Ads inquiry has been received.</p>
          <p className="text-lg text-white/90 mb-8" data-testid="thank-you-description">
            Our TikTok creative team will design viral-worthy content concepts and respond within 24 hours.
          </p>
          ...
          <div className="bg-white/20 backdrop-blur-sm rounded-xl p-6 mb-8" data-testid="next-steps">
            ...
            <ul className="text-left space-y-2 text-white/90">
              <li className="flex items-center">
                ...
                Trend analysis and creative concepts
              </li>
              <li className="flex items-center">
                <CheckCircle className="mr-2 h-5 w-5" />
                Viral content strategy for your brand
              </li>
              <li className="flex items-center">
                <CheckCircle className="mr-2 h-5 w-5" />
                Campaign roadmap delivered within 24 hours
              </li>
            </ul>
          </div>
          
          <Link href="/">
            <Button className="bg-white text-gray-900 px-8 py-3 rounded-lg font-semibold hover:bg-opacity-90 transition-all" data-testid="back-to-home">
