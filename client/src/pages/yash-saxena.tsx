              ...
              <CardContent className="p-8">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-5xl font-bold">$48M</p>
                  </div>
                </div>
                <p className="text-white/90 text-lg">
                  Successfully managed close to <span className="font-bold">$48 million</span> in advertising budgets across global campaigns
                </p>
              </CardContent>
            </Card>
